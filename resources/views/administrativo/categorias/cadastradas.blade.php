        ...
        <div class="row">
            ...
            <div class="box">
                ...
                <div class="box-header">
                    <a data-toggle="modal" data-target="#myModal" class="btn btn-lg btn-primary">Cadastrar</a>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Cadastro Categoria</h4>
                    </div>
                    <form action="{{route('admin.categoria.create')}}" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <select id="segmento" name="segmento_id" required class="form-control">
