    ...
    <section class="content">
        <div class="row">
            ...
            <div class="box">
                ...
                <h3 class="box-title">Produtos ativos no site</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                            ...
                            <div class="modal fade" id="modalArquivar{{$key}}" tabindex="-1" role="dialog" aria-labelledby="exemploModalArquivar{{$key}}" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{route('admin.produto.ativar', ['produto_id' => $produto->id])}}" method="get">
                                            <div class="modal-body">
                                                <h5>Você tem certeza que quer ativar o produto {{$produto->nome}} ?</h5>
                                            </div>
