    ...
    <section class="content">
        <div class="row">
            ...
            <div class="box">
                ...
                <h3 class="box-title">Tabela com usuários cadastrados</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <tr>
                            <td style="cursor: pointer" onclick="location.href='{{ route("user.dados.user.criado") }}'"><img src="{{ asset('administrativo/dist/img/user2-160x160.jpg') }}" class="img-circle" height="40px" width="40px" alt="User Image"></td>
                            <td style="cursor: pointer" onclick="location.href='{{ route("user.dados.user.criado") }}'"> Nome do usuário </td>
                            <td style="cursor: pointer" onclick="location.href='{{ route("user.dados.user.criado") }}'">Email do usuário</td>
                            <td style="cursor: pointer" onclick="location.href='{{ route("user.dados.user.criado") }}'">{{ date('d/m/Y') }}</td>
                            <td>
                                <a href="#" class="btn btn-xs btn-primary">Editar</a>
                                <a href="#" class="btn btn-xs btn-success">Ativar</a>
                                <a href="#" class="btn btn-xs btn-danger">Inativar</a>
                            </td>
                        </tr>
